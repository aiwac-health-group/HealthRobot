...
public class ConnUtil {
     ...
     */
    public static String getResponseString(HttpURLConnection conn) throws IOException, VoiceRException {
     ...
     * @throws VoiceRException http 的状态码不是 200
     */
    public static byte[] getResponseBytes(HttpURLConnection conn) throws IOException, VoiceRException {
        ...
        if (responseCode != 200) {
            ...
            throw new VoiceRException("http response code is" + responseCode);
        }
