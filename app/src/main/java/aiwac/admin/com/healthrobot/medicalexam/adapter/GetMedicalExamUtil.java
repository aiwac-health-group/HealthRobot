    ...
    private static List<MedicalExam> textGetExam(){
        ...
        for(int i=0;i<20;i++){
            ...
            if(i%2==0){
                ...
                medicalExam.setExamContext("入学时有新生体检，入学第一年下学期第二次体检为机能测试体检，第二年机能测试一次体检，第三年又进行第三次机能测试体检，" +
                ...
                medicalExam.setTitle("aiwac员工入职体检");
                ...
                medicalExam.setExamContext("很多同学在体检时感到紧张害怕，尤其是在新生人学时的体检，表现得异常紧张。越是紧张，越是容易在体检中出现问题，" +
